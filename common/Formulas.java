...
public class Formulas {
	...
	public static int calculFinalHeal(Fighter healer, int rank, boolean isCac) {
	...
	public static int calculHonorWin(ArrayList<Fighter> winners,ArrayList<Fighter> loosers,Fighter F)
	{
		...
		if(totalLevelWin-totalLevelLoose > CyonEmu.LVL_PVP) return 0;
	...
	{
		long antNivel = World.getPersoXpMin(lvl);
		long desNivel = World.getPersoXpMax(lvl);
		long nuevaExp = (long) (((desNivel - antNivel) / 4.0) * CyonEmu.XP_PVP);
		return nuevaExp;
	}
