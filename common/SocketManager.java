...
public class SocketManager {
	...
	public static void ENVIAR_Ew_PODS_MONTURA(Personnage perso, int pods) {
   ...
   public static void ENVIAR_EL_LISTA_OBJETOS_DRAGOPAVO(PrintWriter out,
			Dragodinde drago) {
		String packet = (new StringBuilder("EL")).append(
				drago.getListaObjDragopavo()).toString();
		send(out, packet);
		if (CyonEmu.CONFIG_DEBUG)
   ...
   public static void GAME_SEND_FIGHT_CHANGE_OPTION_PACKET_TO_MAP(Carte map,char s,char option, int guid)
	...
	public static void ENVIAR_SB_HECHIZO_BOOST(Personnage perso, String modificacion) {
	...
	public static void GAME_SEND_cMK_PACKET_TO_ALL(Personnage perso , String suffix,int guid,String name,String msg)
	{
		String packet = "cMK"+suffix+"|"+guid+"|"+name+"|"+msg;
        if (perso.get_lvl() < 6) {
        	SocketManager.GAME_SEND_MESSAGE(perso, "Ce canal n'est accessible qu'à partir du niveau <b>6</b>.", CyonEmu.CONFIG_MOTD_COLOR);
            GAME_SEND_BN(perso);
            return;
        }
	...
	public static void ENVIAR_M145_MENSAJE_PANEL_INFORMACION(Personnage perso, String str) {
	...
	public static void GAME_SEND_Ag_PACKET(PrintWriter out, int idObjeto, String codObjeto) {
	...
	public static void ENVIAR_GDF_FORZADO_PERSONAJE(Personnage perso, int celda, int frame, int esInteractivo) {
   ...
   public static void GAME_SEND_PERCO_INFOS_PACKET(Personnage perso, Percepteur perco, String car) 
	...
	public static void SEND_CB_BONUS_CONQUISTA(Personnage pj, String str) {
		String packet = "CB" + str;
		send(pj, packet);

	}
	public static void SEND_Cb_BALANCE_CONQUISTA(Personnage pj, String str) {
		String packet = "Cb" + str;
		send(pj, packet);
	...
	public static void GAME_SEND_PRISME_TO_MAP(Carte Carte, Prisme Prisme) {// envia informacion de todos mercantes en 1 Carte
		String packet = Prisme.getGMPrisme();
		for (Personnage z : Carte.getPersos())
			send(z, packet);

	}
	public static void SEND_CP_INFO_DEFENSEURS_PRISME(Personnage perso, String str) {// info de Percepteur player
		String packet = "CP" + str;
		send(perso, packet);
	}
	
	public static void SEND_Cp_INFO_ATTAQUANT_PRISME(Personnage perso, String str) {// info de Percepteur player
		String packet = "Cp" + str;
		send(perso, packet);
	}
	public static void SEND_CIV_CERRAR_INFO_CONQUISTA(Personnage pj) {
		String packet = "CIV";
		send(pj, packet);

	}
	public static void SEND_CW_INFO_MUNDO_CONQUISTA(Personnage pj, String str) {
