...
public class Trunk {
	...
	public void HopIn(Personnage P)
	{
		...
		{
			SocketManager.GAME_SEND_MESSAGE(P, "Ce coffre ne peut être ouvert que par les membres de la guilde !", CyonEmu.CONFIG_MOTD_COLOR);
		return;
		}
	...
	public void addInTrunk(int guid, int qua, Personnage P)
	{
		...
		{
			SocketManager.GAME_SEND_MESSAGE(P, "Le nombre d'objets maximal de ce coffre à été atteint !", CyonEmu.CONFIG_MOTD_COLOR);
			return;
		}
